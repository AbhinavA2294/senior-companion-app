    ...
    <div className="space-y-6 max-w-2xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-senior-base text-gray-500 mt-1">Updates about bookings for your loved ones.</p>
        </div>
        {unreadCount > 0 && (
      ...
      {items.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-senior-base text-gray-400 mt-1">
            You&apos;ll be notified here when bookings are confirmed, updated, or cancelled.
          </p>
        </div>
      ) : (
