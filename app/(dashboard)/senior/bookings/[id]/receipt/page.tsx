...
export default async function SeniorBookingReceiptPage({ params }: Props) {
  ...
  const { data: booking } = await admin
    ...
    .select(`
      ...
      location_description, senior_profile_id, booked_by_profile_id,
  ...
  return (
    <div className="max-w-lg space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">{actType?.name ?? "Companion Visit"}</p>
      </div>
